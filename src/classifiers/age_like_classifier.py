...
if __name__ == "__main__":
    ...
    merged_df['age'] = pd.cut(merged_df['age'], [0, 25, 35, 50, 200], labels=["xx-24", "25-34", "35-49", "50-xx"],
                              right=False)
    mdf = merged_df.filter(['age'], axis=1)
    ...
    # fit_df = pd.concat([one_hot, mdf], axis=1)
    ...
    # [0.66666667 0.62189055 0.615      0.625      0.58080808]

    # print(cross_val_score(clf, one_hot1000, mdf1000, cv=5))
